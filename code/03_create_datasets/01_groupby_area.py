...
if __name__ == '__main':
    ...
    # define date range
    date_range_off = pd.date_range('2002', '2017', freq='MS', closed='left')
    ...
    products = [
        ...
        {'path': 'MODIS/MOD13A3/prepared', 'col': 'ppt', 'stat': 'mean',
         'compute_prev': True, 'date_range': date_range_off},
        {'path': 'TRMM/3B43/prepared', 'col': 'ppt', 'stat': 'mean',
         'compute_prev': True, 'date_range': date_range},
    ]
    ...
    df.to_csv('../csv/groupby_area.csv', index=False)
